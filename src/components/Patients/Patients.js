...
render() {
    ...
    return (
      ...
      <View>
      <SearchBar icon  clearIcon lightTheme onChangeText={(term) => this.searchBarChangeText(term)} onClearText={() => this.searchBarClearText()} placeholder='Search' ref={search => this.search = search} />
      </View>
      <View>
      <FlatList
        style={styles.list}
